...
def searchXORChar(encodedString):
    ...
    for i in range(0,256):
        ...
        xorChar = '{:x}'.format(i)
        xorCharFin = ''
        for x in range(1, int(len(importString)/2)+1):
            if (len(xorChar) == 1):
...
# Import string
importString = '1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736'

# Find the char which gives the highest encryption score
maxScore, maxKey, maxEncrypted = searchXORChar(importString)
